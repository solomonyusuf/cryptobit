            ...
            <div class="MuiBox-root css-nkvznt">
               <div class="MuiBox-root css-1qm1lh">
                  <div class="MuiBox-root css-1coeexk">
                     ...
                     <div class="MuiBox-root css-1570kgy"><img src="https://app.aave.com/icons/networks/ethereum.svg" style="margin-top:-9px;" height="100%" width="100%" alt="Ethereum Mainnet"></div>
                     <p class="MuiTypography-root MuiTypography-subheader2 css-fodyq8">Ethereum Mainnet</p>
                  </div>
                  <div class="MuiBox-root css-1coeexk">
                     <h1 class="MuiTypography-root MuiTypography-display1 css-16489wl">Aave Governance</h1>
                  </div>
                  <p class="MuiTypography-root MuiTypography-description css-mg5q4r">Aave is a fully decentralized, community governed protocol by the AAVE token-holders. AAVE token-holders collectively discuss, propose, and vote on upgrades to the protocol. AAVE token-holders (Ethereum network only) can either vote themselves on new proposals or delagate to an address of choice. To learn more check out the Governance <a class="MuiTypography-root MuiTypography-description MuiLink-root MuiLink-underlineNone css-1qtstx3" href="https://docs.aave.com/faq/governance" target="_blank" rel="noopener">documentation</a>.</p>
               </div>
               <div class="MuiBox-root css-k7vncv">
                  <div class="MuiBox-root css-gc7fdh">
                     <a class="MuiTypography-root MuiTypography-description MuiLink-root MuiLink-underlineNone MuiButtonBase-root MuiButton-root MuiButton-surface MuiButton-surfacePrimary MuiButton-sizeSmall MuiButton-surfaceSizeSmall MuiButton-colorPrimary MuiButton-disableElevation MuiButton-root MuiButton-surface MuiButton-surfacePrimary MuiButton-sizeSmall MuiButton-surfaceSizeSmall MuiButton-colorPrimary MuiButton-disableElevation css-1qyv9ui" href="https://snapshot.org/#/aave.eth" target="_blank" rel="noopener" tabindex="0">
                     ...
                     <a class="MuiTypography-root MuiTypography-description MuiLink-root MuiLink-underlineNone MuiButtonBase-root MuiButton-root MuiButton-surface MuiButton-surfacePrimary MuiButton-sizeSmall MuiButton-surfaceSizeSmall MuiButton-colorPrimary MuiButton-disableElevation MuiButton-root MuiButton-surface MuiButton-surfacePrimary MuiButton-sizeSmall MuiButton-surfaceSizeSmall MuiButton-colorPrimary MuiButton-disableElevation css-1qyv9ui" href="https://governance.aave.com/" target="_blank" rel="noopener" tabindex="0">
                        <div class="MuiBox-root css-70qvj9">
                           FORUM
                           <svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-1ej2kgu" focusable="false" aria-hidden="true" viewBox="0 0 24 24">
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                     ...
                     <a class="MuiTypography-root MuiTypography-description MuiLink-root MuiLink-underlineNone MuiButtonBase-root MuiButton-root MuiButton-surface MuiButton-surfacePrimary MuiButton-sizeSmall MuiButton-surfaceSizeSmall MuiButton-colorPrimary MuiButton-disableElevation MuiButton-root MuiButton-surface MuiButton-surfacePrimary MuiButton-sizeSmall MuiButton-surfaceSizeSmall MuiButton-colorPrimary MuiButton-disableElevation css-1qyv9ui" href="https://docs.aave.com/faq/governance" target="_blank" rel="noopener" tabindex="0">
                        <div class="MuiBox-root css-70qvj9">
                           FAQ
                           <svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-1ej2kgu" focusable="false" aria-hidden="true" viewBox="0 0 24 24">
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                     ...
                     <a class="MuiTypography-root MuiTypography-description MuiLink-root MuiLink-underlineNone MuiButtonBase-root MuiButton-root MuiButton-surface MuiButton-surfacePrimary MuiButton-sizeSmall MuiButton-surfaceSizeSmall MuiButton-colorPrimary MuiButton-disableElevation MuiButton-root MuiButton-surface MuiButton-surfacePrimary MuiButton-sizeSmall MuiButton-surfaceSizeSmall MuiButton-colorPrimary MuiButton-disableElevation css-1qyv9ui" href="https://governance-v2.aave.com/" target="_blank" rel="noopener" tabindex="0">
                        <div class="MuiBox-root css-70qvj9">
                           GOVERNANCE V2
                           <svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-1ej2kgu" focusable="false" aria-hidden="true" viewBox="0 0 24 24">
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
      ...
      <div class="MuiBox-root css-159pi92">
         <div class="MuiContainer-root MuiContainer-maxWidthLg css-1a8qn2o">
            ...
            <div class="MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-4 css-isbt42">
               <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-md-8 css-3nwm7d">
                  <div class="MuiPaper-root MuiPaper-elevation MuiPaper-rounded MuiPaper-elevation1 css-1gl5nn9">
                     <div class="MuiBox-root css-1j98xai">
                        ...
                        <div class="MuiBox-root css-c6rw7y">
                           ...
                           <div class="MuiInputBase-root MuiInputBase-colorPrimary css-bhhpxe"><input placeholder="Search proposals" type="text" class="MuiInputBase-input css-8crlfm" value=""></div>
                     ...
                     <div>
                        <a class="MuiTypography-root MuiTypography-description MuiLink-root MuiLink-underlineNone MuiBox-root css-1oiqa56" href="/governance/v3/proposal/?proposalId=250">
                           <div class="MuiStack-root css-1gb8agv">
                              <div class="MuiStack-root css-2j5iyq"><span class="css-5ck20f">Open for voting</span></div>
                              <h3 class="MuiTypography-root MuiTypography-h3 css-1a8e2hd">stkBPT Incentives</h3>
                           </div>
                           <div class="MuiStack-root css-1jvvlbg">
                              <div class="MuiBox-root css-1qm1lh">
                                 <div class="MuiBox-root css-k008qs">
                                    <p class="MuiTypography-root MuiTypography-description css-181zdd">YAE</p>
                                    <span class="MuiBox-root css-i9gxme">
                                       <p class="MuiTypography-root MuiTypography-secondary14 MuiTypography-noWrap css-18g3jbb">93K</p>
                                    </span>
                                    <p class="MuiTypography-root MuiTypography-caption MuiTypography-noWrap css-1wdnhoq">100.00<span class="MuiTypography-root MuiTypography-caption css-g4z180">%</span></p>
                                 </div>
                                 <div class="css-oi2ryi"><span class="css-14s30ua"></span></div>
                              </div>
                              <div class="MuiBox-root css-0">
                                 <div class="MuiBox-root css-k008qs">
                                    <p class="MuiTypography-root MuiTypography-description css-181zdd">NAY</p>
                                    <span class="MuiBox-root css-i9gxme">
                                       <p class="MuiTypography-root MuiTypography-secondary14 MuiTypography-noWrap css-18g3jbb">0</p>
                                    </span>
                                    <p class="MuiTypography-root MuiTypography-caption MuiTypography-noWrap css-1wdnhoq">0<span class="MuiTypography-root MuiTypography-caption css-g4z180">%</span></p>
                                 </div>
                                 <div class="css-oi2ryi"><span class="css-1qxqp2f"></span></div>
                              </div>
                           </div>
                        </a>
                        <a class="MuiTypography-root MuiTypography-description MuiLink-root MuiLink-underlineNone MuiBox-root css-1oiqa56" href="/governance/v3/proposal/?proposalId=249">
                           <div class="MuiStack-root css-1gb8agv">
                              <div class="MuiStack-root css-2j5iyq"><span class="css-5ck20f">Open for voting</span></div>
                              <h3 class="MuiTypography-root MuiTypography-h3 css-1a8e2hd">a.DI Sonic path activation</h3>
                           </div>
                           <div class="MuiStack-root css-1jvvlbg">
                              <div class="MuiBox-root css-1qm1lh">
                                 <div class="MuiBox-root css-k008qs">
                                    <p class="MuiTypography-root MuiTypography-description css-181zdd">YAE</p>
                                    <span class="MuiBox-root css-i9gxme">
                                       <p class="MuiTypography-root MuiTypography-secondary14 MuiTypography-noWrap css-18g3jbb">442K</p>
                                    </span>
                                    <p class="MuiTypography-root MuiTypography-caption MuiTypography-noWrap css-1wdnhoq">100.00<span class="MuiTypography-root MuiTypography-caption css-g4z180">%</span></p>
                                 </div>
                                 <div class="css-oi2ryi"><span class="css-14s30ua"></span></div>
                        ...
                        <a class="MuiTypography-root MuiTypography-description MuiLink-root MuiLink-underlineNone MuiBox-root css-1oiqa56" href="/governance/v3/proposal/?proposalId=248">
                           <div class="MuiStack-root css-1gb8agv">
                              <div class="MuiStack-root css-2j5iyq"><span class="css-5ck20f">Executed</span></div>
                              <h3 class="MuiTypography-root MuiTypography-h3 css-1a8e2hd">Request for Bounty Payout - Feb 2025</h3>
                           </div>
                           <div class="MuiStack-root css-1jvvlbg">
                              <div class="MuiBox-root css-1qm1lh">
                                 <div class="MuiBox-root css-k008qs">
                                    <p class="MuiTypography-root MuiTypography-description css-181zdd">YAE</p>
                                    <span class="MuiBox-root css-i9gxme">
                                       <p class="MuiTypography-root MuiTypography-secondary14 MuiTypography-noWrap css-18g3jbb">742K</p>
                                    </span>
                                    <p class="MuiTypography-root MuiTypography-caption MuiTypography-noWrap css-1wdnhoq">100.00<span class="MuiTypography-root MuiTypography-caption css-g4z180">%</span></p>
                                 </div>
                                 <div class="css-oi2ryi"><span class="css-14s30ua"></span></div>
                        ...
                        <a class="MuiTypography-root MuiTypography-description MuiLink-root MuiLink-underlineNone MuiBox-root css-1oiqa56" href="/governance/v3/proposal/?proposalId=247">
                           <div class="MuiStack-root css-1gb8agv">
                              <div class="MuiStack-root css-2j5iyq"><span class="css-5ck20f">Executed</span></div>
                              <h3 class="MuiTypography-root MuiTypography-h3 css-1a8e2hd">Decrease Slope1 Parameter for Stablecoins on Aave V3</h3>
                           </div>
                           <div class="MuiStack-root css-1jvvlbg">
                              <div class="MuiBox-root css-1qm1lh">
                                 <div class="MuiBox-root css-k008qs">
                                    <p class="MuiTypography-root MuiTypography-description css-181zdd">YAE</p>
                                    <span class="MuiBox-root css-i9gxme">
                                       <p class="MuiTypography-root MuiTypography-secondary14 MuiTypography-noWrap css-18g3jbb">732K</p>
                                    </span>
                                    <p class="MuiTypography-root MuiTypography-caption MuiTypography-noWrap css-1wdnhoq">100.00<span class="MuiTypography-root MuiTypography-caption css-g4z180">%</span></p>
                                 </div>
                                 <div class="css-oi2ryi"><span class="css-14s30ua"></span></div>
                        ...
                        <a class="MuiTypography-root MuiTypography-description MuiLink-root MuiLink-underlineNone MuiBox-root css-1oiqa56" href="/governance/v3/proposal/?proposalId=246">
                           <div class="MuiStack-root css-1gb8agv">
                              <div class="MuiStack-root css-2j5iyq"><span class="css-5ck20f">Executed</span></div>
                              <h3 class="MuiTypography-root MuiTypography-h3 css-1a8e2hd">February Funding Update (Part 1)</h3>
                           </div>
                           <div class="MuiStack-root css-1jvvlbg">
                              <div class="MuiBox-root css-1qm1lh">
                                 <div class="MuiBox-root css-k008qs">
                        ...
                        <a class="MuiTypography-root MuiTypography-description MuiLink-root MuiLink-underlineNone MuiBox-root css-1oiqa56" href="/governance/v3/proposal/?proposalId=245">
                           <div class="MuiStack-root css-1gb8agv">
                              <div class="MuiStack-root css-2j5iyq"><span class="css-5ck20f">Executed</span></div>
                              <h3 class="MuiTypography-root MuiTypography-h3 css-1a8e2hd">Aave v3 Linea Activation</h3>
                           </div>
                           <div class="MuiStack-root css-1jvvlbg">
                              <div class="MuiBox-root css-1qm1lh">
                                 <div class="MuiBox-root css-k008qs">
                                    <p class="MuiTypography-root MuiTypography-description css-181zdd">YAE</p>
                                    <span class="MuiBox-root css-i9gxme">
                                       <p class="MuiTypography-root MuiTypography-secondary14 MuiTypography-noWrap css-18g3jbb">733K</p>
                                    </span>
                                    <p class="MuiTypography-root MuiTypography-caption MuiTypography-noWrap css-1wdnhoq">100.00<span class="MuiTypography-root MuiTypography-caption css-g4z180">%</span></p>
                                 </div>
                                 <div class="css-oi2ryi"><span class="css-14s30ua"></span></div>
                        ...
                        <a class="MuiTypography-root MuiTypography-description MuiLink-root MuiLink-underlineNone MuiBox-root css-1oiqa56" href="/governance/v3/proposal/?proposalId=244">
                           <div class="MuiStack-root css-1gb8agv">
                              <div class="MuiStack-root css-2j5iyq"><span class="css-5ck20f">Executed</span></div>
                              <h3 class="MuiTypography-root MuiTypography-h3 css-1a8e2hd">wstETH Borrow Rate Update</h3>
                           </div>
                           <div class="MuiStack-root css-1jvvlbg">
                              <div class="MuiBox-root css-1qm1lh">
                                 <div class="MuiBox-root css-k008qs">
                        ...
                        <a class="MuiTypography-root MuiTypography-description MuiLink-root MuiLink-underlineNone MuiBox-root css-1oiqa56" href="/governance/v3/proposal/?proposalId=243">
                           <div class="MuiStack-root css-1gb8agv">
                              <div class="MuiStack-root css-2j5iyq"><span class="css-5ck20f">Executed</span></div>
                              <h3 class="MuiTypography-root MuiTypography-h3 css-1a8e2hd">Allow Balancer To Claim Mining Rewards</h3>
                           </div>
                           <div class="MuiStack-root css-1jvvlbg">
                              <div class="MuiBox-root css-1qm1lh">
                                 <div class="MuiBox-root css-k008qs">
                        ...
                        <a class="MuiTypography-root MuiTypography-description MuiLink-root MuiLink-underlineNone MuiBox-root css-1oiqa56" href="/governance/v3/proposal/?proposalId=242">
                           <div class="MuiStack-root css-1gb8agv">
                              <div class="MuiStack-root css-2j5iyq"><span class="css-5ck20f">Executed</span></div>
                              <h3 class="MuiTypography-root MuiTypography-h3 css-1a8e2hd">Update USDS &amp; GHO Borrow Rate</h3>
                           </div>
                           <div class="MuiStack-root css-1jvvlbg">
                              <div class="MuiBox-root css-1qm1lh">
                                 <div class="MuiBox-root css-k008qs">
                        ...
                        <a class="MuiTypography-root MuiTypography-description MuiLink-root MuiLink-underlineNone MuiBox-root css-1oiqa56" href="/governance/v3/proposal/?proposalId=241">
                           <div class="MuiStack-root css-1gb8agv">
                              <div class="MuiStack-root css-2j5iyq"><span class="css-5ck20f">Executed</span></div>
                              <h3 class="MuiTypography-root MuiTypography-h3 css-1a8e2hd">Sunset stMATIC on Polygon instance</h3>
                           </div>
                           <div class="MuiStack-root css-1jvvlbg">
                              <div class="MuiBox-root css-1qm1lh">
                                 <div class="MuiBox-root css-k008qs">
               ...
               <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-md-4 css-emkqy0">
                  <div class="MuiPaper-root MuiPaper-elevation MuiPaper-rounded MuiPaper-elevation1 css-vlwc29">
                     <h3 class="MuiTypography-root MuiTypography-h3 css-94tddk">Your info</h3>
                     <div class="MuiBox-root css-axw7ok">
                        <span class="MuiBadge-root css-1rzb3uu">
                           <div class="MuiAvatar-root MuiAvatar-circular css-1r1fyrk"><img alt="avatar" style="border-radius:50%;" src="data:image/svg+xml;base64," class="MuiAvatar-img css-1hy9t21"></div>
                           <span class="MuiBadge-badge MuiBadge-standard MuiBadge-invisible MuiBadge-anchorOriginBottomRight MuiBadge-anchorOriginBottomRightCircular MuiBadge-overlapCircular css-g2bxhl">
                              <svg class="MuiSvgIcon-root MuiSvgIcon-colorWarning MuiSvgIcon-fontSizeMedium css-6zxo4b" focusable="false" aria-hidden="true" viewBox="0 0 24 24">
                        ...
                        <div class="MuiBox-root css-j7qwjs">
                           <div class="MuiBox-root css-171onha">
                              <h4 class="MuiTypography-root MuiTypography-h4 css-cg4wfg">0xb9b6b...4b40</h4>
                              <div>
                     ...
                     <div class="MuiBox-root css-1rwr66l" style="display: flex; margin-top: 24px;gap:1.5em;">
                        <div class="MuiBox-root css-1ir4d68">
                           <div class="MuiBox-root css-70qvj9">
                              <p class="MuiTypography-root MuiTypography-description css-1t8x1s2">Voting power</p>
                           ...
                           <h4 class="MuiTypography-root MuiTypography-h2 MuiTypography-noWrap css-1ab1w3v" data-cy="voting-power">0</h4>
                        </div>
                        <div class="MuiBox-root css-0">
                           <div class="MuiBox-root css-70qvj9">
                              <p class="MuiTypography-root MuiTypography-description css-1t8x1s2">Proposition power</p>
                              <div class="MuiBox-root css-ulme3a">
                                 <button class="MuiButtonBase-root MuiIconButton-root MuiIconButton-sizeMedium css-1osfq0k" tabindex="0" type="button">
                                    <svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-jmow5f" focusable="false" aria-hidden="true" viewBox="0 0 24 24">
                                       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                           ...
                           <h4 class="MuiTypography-root MuiTypography-h2 MuiTypography-noWrap css-1ab1w3v" data-cy="proposition-power">0</h4>
                        </div>
                     </div>
                  </div>
                  <div class="MuiPaper-root MuiPaper-elevation MuiPaper-rounded MuiPaper-elevation1 css-30ugv3">
                     <div class="MuiBox-root css-1vfij0r">
                        <p class="MuiTypography-root MuiTypography-description css-1936jdx">Delegated power</p>
                        <p class="MuiTypography-root MuiTypography-description css-odk21d MuiTypography-root MuiTypography-description css-1t8x1s2">Use your AAVE, stkAAVE, or aAave balance to delegate your voting and proposition powers. You will not be sending any tokens, only the rights to vote and propose changes to the protocol. You can re-delegate or revoke power to self at any time.<a class="MuiTypography-root MuiTypography-description MuiLink-root MuiLink-underlineNone css-14dz41l" href="https://docs.aave.com/developers/v/2.0/protocol-governance/governance" target="_blank" rel="noopener">Learn more.</a></p>
                        <p class="MuiTypography-root MuiTypography-description css-1j6cneu MuiTypography-root MuiTypography-description css-1t8x1s2">You have no AAVE/stkAAVE/aAave balance to delegate.</p>
                     </div>
                     <hr class="MuiDivider-root MuiDivider-fullWidth css-1301pmg">
                     <div class="MuiBox-root css-cyk6x5"><button class="MuiButtonBase-root MuiButton-root MuiButton-contained MuiButton-containedPrimary MuiButton-sizeLarge MuiButton-containedSizeLarge MuiButton-colorPrimary MuiButton-disableElevation Mui-disabled MuiButton-root MuiButton-contained MuiButton-containedPrimary MuiButton-sizeLarge MuiButton-containedSizeLarge MuiButton-colorPrimary MuiButton-disableElevation css-1c7ud3q" tabindex="-1" type="button">Set up delegation</button></div>
                  </div>
                  <div class="MuiPaper-root MuiPaper-elevation MuiPaper-rounded MuiPaper-elevation1 css-30ugv3">
                     <div class="MuiBox-root css-1vfij0r">
                        <div class="MuiStack-root css-1ialerq">
                           <p class="MuiTypography-root MuiTypography-description css-1936jdx">Linked addresses</p>
                           <button class="MuiButtonBase-root MuiButton-root MuiButton-text MuiButton-textPrimary MuiButton-sizeMedium MuiButton-textSizeMedium MuiButton-colorPrimary MuiButton-disableElevation MuiButton-root MuiButton-text MuiButton-textPrimary MuiButton-sizeMedium MuiButton-textSizeMedium MuiButton-colorPrimary MuiButton-disableElevation css-19dxac3" tabindex="0" type="button">
                              <p class="MuiTypography-root MuiTypography-description css-sw696k">Edit</p>
                              <span class="MuiTouchRipple-root css-w0pj6f"></span>
                           </button>
                        </div>
                        <div class="MuiStack-root css-bi23zc">
                           <div class="MuiStack-root css-j7qwjs">
                              <p class="MuiTypography-root MuiTypography-description css-1t8x1s2">Representative smart contract wallet (ie. Safe) addresses on other chains.</p>
                           </div>
                           <div class="MuiStack-root css-1dvntee">
                              <div class="MuiStack-root css-ucb7px">
                                 <div style="display:flex;gap:1rem;" class="MuiStack-root css-8v90jo">
                                    <img src="https://app.aave.com/icons/networks/polygon.svg" height="16px" width="16px" alt="network logo">
                                    <p class="MuiTypography-root MuiTypography-subheader1 css-fu4g2f">Polygon POS</p>
                                 </div>
                                 <div class="MuiStack-root css-1r9kwv0" style="display:flex;gap:1rem;">
                                    <button class="MuiButtonBase-root MuiIconButton-root MuiIconButton-sizeMedium css-17pel43" tabindex="0" type="button">
                                       <svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-180iv8j" focusable="false" aria-hidden="true" viewBox="0 0 24 24">
                                          <svg xmlns="http://www.w3.org/2000/svg"  fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                                    ...
                                    <p class="MuiTypography-root MuiTypography-subheader1 css-1kqxfxi">Connect</p>
                                 </div>
                              </div>
                              <div class="MuiStack-root css-ucb7px">
                                 <div style="display:flex;gap:1rem;" class="MuiStack-root css-8v90jo">
                                    <img src="https://app.aave.com/icons/networks/avalanche.svg" height="16px" width="16px" alt="network logo">
                                    <p class="MuiTypography-root MuiTypography-subheader1 css-fu4g2f">Avalanche</p>
                                 </div>
                                 <div class="MuiStack-root css-1r9kwv0">
                                    <button class="MuiButtonBase-root MuiIconButton-root MuiIconButton-sizeMedium css-17pel43" tabindex="0" type="button">
                                       <svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-180iv8j" focusable="false" aria-hidden="true" viewBox="0 0 24 24">
                                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                                             <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"></path>
...
.css-17pel43 {
  ...
  height: 24px;
  width: 24px;
  background: rgba(235, 235, 239, 0.08);
}
.css-1kqxfxi {
  margin: 0px;
